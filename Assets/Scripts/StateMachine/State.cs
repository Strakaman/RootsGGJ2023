...
{
    protected float time { get; set; } //total time passed from Update
    protected float fixedtime { get; set; } //total time passed from FixedUpdate
    protected float latetime { get; set; } //total time passed from LateUpdate
